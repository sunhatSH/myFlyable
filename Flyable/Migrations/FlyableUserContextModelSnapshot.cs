...
namespace Flyable.Migrations
{
    ...
    partial class FlyableUserContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flyable.Repositories.Entities.NovelTag", b =>
                {
            ...
            modelBuilder.Entity("Flyable.Repositories.Entities.Post", b =>
                {
                    ...
                    b.HasIndex("PostId", "UserId", "LastAlterTime", "PublishTime");
            ...
            modelBuilder.Entity("Flyable.Repositories.Entities.PostTag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PostPostTag", b =>
                {
                    ...
                    b.HasKey("PostTagsTagId", "PostsPostId");
            ...
            modelBuilder.Entity("UserUser", b =>
                {
                    ...
                    b.HasKey("FollowedUserId", "FollowsUserId");
            ...
            modelBuilder.Entity("NovelNovelTag", b =>
                {
                    b.HasOne("Flyable.Repositories.Entities.NovelTag", null)
                        .WithMany()
                        .HasForeignKey("NovelTagsTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Flyable.Repositories.Entities.Novel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PostPostTag", b =>
                {
                    b.HasOne("Flyable.Repositories.Entities.PostTag", null)
                        .WithMany()
                        .HasForeignKey("PostTagsTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Flyable.Repositories.Entities.Post", null)
                        .WithMany()
