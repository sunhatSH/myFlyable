...
class PageManager {
     ...
     * 加载模板内容
     */
    private async loadTemplateContent(url: string): Promise<string> {
        try {
     ...
     * 渲染页面
     */
    async renderPage(config: PageConfig): Promise<void> {
        // 调用上一个页面的卸载方法
     ...
     * 渲染组件
     */
    private async renderComponents(components: { [key: string]: any }): Promise<void> {
...
declare function updatePageLanguage(): void;
